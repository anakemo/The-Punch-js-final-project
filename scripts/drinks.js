...
let typeddrink=document.getElementById("searchSpace");
let drinksArray=[];



// get info from data and create drinks boxes
...
function createCocktailsLogic(item){
    ...
    h3cocktails.classList.add("h3cocktails");
...
typeddrink.addEventListener("input",function(event){
